...
### Важно! Доступ по IP
На хостинге Beget подключение к базе данных ограничено по IP-адресам. Чтобы вы могли подключиться, необходимо добавить ваш текущий IP-адрес в список разрешённых в панели управления Beget.

**Как добавить IP:**
1. Зайдите в панель управления Beget ([https://cp.beget.com/mysql](https://cp.beget.com/mysql))  под логином 'theomasw' и паролем '%*9AQyhWAnxL'
